...
<head>
  ...
  <!-- OG Meta Tags -->
  <meta property="og:title" content="Login Page - Skill Connect | Your Trusted Job Portal in Bangladesh" />
  <meta property="og:description" content="Login from here as an Employer to post jobs or as a candidate, a job seeker. Start finding
  your next career opportunity today in Bangladesh." />
  <meta property="og:image" content="/assets/img/hero/login.jpg" />
  ...
  ?>
  <meta property=" og:url" content="<?= htmlspecialchars($baseUrl); ?>/login.php" />
  ...
  <!-- Write informations from the cookie to the form -->
  <script>
...
<body class="d-flex justify-content-center align-items-center bg-light vh-100">
  <section class="card shadow-lg p-4" style="max-width: 600px;">
    ...
    <div class="card-body">
      ...
      <!-- login using github -->
      <a
        href="https://github.com/login/oauth/authorize?client_id=Ov23liOnO6vm8ZU69Rh8&redirect_uri=<?= urlencode('http://localhost/Skill_Connect_Project/github-callback.php') ?>&scope=user:email">
